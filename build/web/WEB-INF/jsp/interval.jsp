                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="abTimetableEntry" items="${dayEntry.value.abTimetable}">
                                                                <tr style="background-color:${abTimetableEntry.value.type==typeAnchor&&abTimetableEntry.value.getStartTimeScheduled()==startTimeAnchor ? "lightgreen" : "inherited" };">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="abGpsTimetableEntry" items="${dayEntry.value.abGpsTimetable}">
                                                                <tr style="background-color:${abGpsTimetableEntry.value.type==typeAnchor&&abGpsTimetableEntry.value.getStartTimeScheduled()==startTimeAnchor ? "lightgreen" : "inherited" };">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="baTimetableEntry" items="${dayEntry.value.baTimetable}">
                                                                <tr style="background-color:${baTimetableEntry.value.type==typeAnchor&&baTimetableEntry.value.getStartTimeScheduled()==startTimeAnchor ? "lightgreen" : "inherited" };">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="baGpsTimetableEntry" items="${dayEntry.value.baGpsTimetable}">
                                                                <tr style="background-color:${baGpsTimetableEntry.value.type==typeAnchor&&baGpsTimetableEntry.value.getStartTimeScheduled()==startTimeAnchor ? "lightgreen" : "inherited" };">
