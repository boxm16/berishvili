...
//setting date 1904 system (to show negative duration in excel workbook)
    ...
    void SXSSF_DetailedRoutes(TreeMap<Float, DetailedRoute> detailedRoutes, String fileName) {
        ...
        try (SXSSFWorkbook workbook = new SXSSFWorkbook(100);
            ...
            /*
            boolean newRoute;
            int newRouteStartIndex = 0;
            boolean newDay;
            int newDayStartIndex = 0;
            boolean newExodus;
            int newExodusStartIndex = 0;
            boolean newTripVoucher;
            int newTripVoucherStartIndex = 0;
             */
            for (Map.Entry<Float, DetailedRoute> detailedRouteEntry : detailedRoutes.entrySet()) {
                        ...
                        for (Map.Entry<String, TripVoucher> tripVouchersEntry : tripVouchers.entrySet()) {
                            ...
                            for (TripPeriod tripPeriodA : tripPeriods) {
                                ...
                                if (newRoute) {
                                    ...
                                    Cell routeNumberCell = row.createCell(0);
                                    routeNumberCell.setCellValue("");
                                    routeNumberCell.setCellStyle(rowStyleWhiteRegular);
                                }
                                if (newDay) {
                                    newDayStartIndex = rowIndex;
                                    ...
                                    Cell dateStampCell = row.createCell(1);
                                    dateStampCell.setCellValue("");
                                    dateStampCell.setCellStyle(rowStyleWhiteRegular);
                                }
                                if (newExodus) {
                                    newExodusStartIndex = rowIndex;
                                    ...
                                    Cell exodusCell = row.createCell(2);
                                    exodusCell.setCellValue("");
                                    exodusCell.setCellStyle(rowStyleWhiteRegular);
                                }
                                if (newTripVoucher) {
                                    newTripVoucherStartIndex = rowIndex;
                                    ...
                                    newTripVoucher = false;
                                } else {
                                    Cell tripVoucherCell = row.createCell(3);
                                    tripVoucherCell.setCellValue("");
                                    tripVoucherCell.setCellStyle(rowStyleWhiteRegular);
                                }*/
                                ...
                                startTimeScheduledCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                arrivalTimeActualCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                arrivalTimeDifferenceCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                tripPeriodTimeScheduledCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                tripPeriodTimeActualCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                if (tripPeriod.getTripPeriodTimeDifferenceExcelFormat() == null) {
                                    ...
                                    tripPeriodTimeDifferenceCell.setCellValue(tripPeriod.getTripPeriodTimeActualExcelFormat());
                                }
                                tripPeriodTimeDifferenceCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                haltTimeScheduledCell.setCellStyle(rowStyleWhiteTimeHHmm);
                                ...
                                haltTimeActualCell.setCellStyle(rowStyleWhiteTimeHHmm);
                ...
                for (int x = 0; x < 19; x++) {
                    ...
                    row.setHeightInPoints(rowHeigth);
                    Cell startTimeScheduledCell = row.createCell(x);
                    startTimeScheduledCell.setCellValue("------");
                    startTimeScheduledCell.setCellStyle(rowStyleWhiteRegular);
                }
