...
public class TechController {
    ...
    public String deleteTables(ModelMap model) throws SQLException {
        //sequence is important (i think :) )
        String lastUploadTableDeletionStatus = techDao.deleteLastUploadTable();
        String tripPeriodTableDeletionStatus = techDao.deleteTripPeriodTable();
        String tripVoucherTableDeletionStatus = techDao.deleteTripVoucherTable();
        String routeTableDeletionStatus = techDao.deleteRouteTable();

        model.addAttribute("routeTableDeletionStatus", routeTableDeletionStatus
                + "<br>" + lastUploadTableDeletionStatus
    ...
    @RequestMapping(value = "createConfigXML")
    public String createConfigXML() {
        ConfigWriter configWriter = new ConfigWriter();
        configWriter.saveConfigFile(1);
        return "techMan";
    }
