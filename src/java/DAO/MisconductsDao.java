...
public class MisconductsDao {
    ...
    public ArrayList<FirstTripPeriod> getMisconductedFirstTripPeriods(DetailedRoutesPager detailedRoutesPager) {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    if (tripVoucher.getTripPeriods().size() < 2) {
                        ...
                        tripVoucher.getTripPeriods().add(newTripPeriod);
                        if (tripVoucher.getTripPeriods().size() == 2) {
                            FirstTripPeriod firstTripPeriod = calculateFirstTripPeriodAndBaseMisconduct(tripVoucher.getTripPeriods().get(0), tripVoucher.getTripPeriods().get(1));
